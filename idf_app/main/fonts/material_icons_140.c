 ...
 * Size: 140 px
 * Bpp: 4
 * Opts: --bpp 4 --size 140 --font MaterialIcons-Regular.ttf --range 0xE04F --format lvgl --no-compress --no-prefilter -o material_icons_140.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 2240, .box_w = 106, .box_h = 106, .ofs_x = 17, .ofs_y = 17}
};
...
{
    {
        .range_start = 57423, .range_length = 1, .glyph_id_start = 1,
