 ...
 * Size: 60 px
 * Bpp: 4
 * Opts: --bpp 4 --size 60 --font MaterialIcons-Regular.ttf --range 0xE000,0xE002,0xE019,0xE034,0xE037,0xE044-0xE045,0xE04D-0xE050,0xE1A3,0xE1A7,0xE307,0xE32D,0xE333,0xE405,0xE5C4,0xE5CA-0xE5CD,0xE5D5,0xE63E,0xE648,0xE88A,0xE88E,0xE8B6,0xE8B8,0xF090 --format lvgl --no-compress --no-prefilter -o material_icons_60.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x0, 0xcf, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xef, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xfe, 0x0, 0x0, 0x0, 0x0, 0x7, 0xff, 0xd1,
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xf0, 0xbf, 0xff, 0xfd, 0xcc,
    0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc,
    0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc,
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0xdf, 0xff, 0xf1, 0xcf, 0xff, 0xf4, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0xdf, 0xff, 0xf1, 0xbf, 0xff, 0xfc, 0xbb,
    0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb,
    0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb,
    0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xff, 0xff, 0xf0,
    0x9f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2594, .adv_w = 960, .box_w = 50, .box_h = 50, .ofs_x = 5, .ofs_y = 5},
    {.bitmap_index = 3844, .adv_w = 960, .box_w = 30, .box_h = 36, .ofs_x = 15, .ofs_y = 12},
    {.bitmap_index = 4384, .adv_w = 960, .box_w = 28, .box_h = 36, .ofs_x = 20, .ofs_y = 12},
    {.bitmap_index = 4888, .adv_w = 960, .box_w = 30, .box_h = 30, .ofs_x = 15, .ofs_y = 15},
    {.bitmap_index = 5338, .adv_w = 960, .box_w = 30, .box_h = 30, .ofs_x = 15, .ofs_y = 15},
    {.bitmap_index = 5788, .adv_w = 960, .box_w = 35, .box_h = 41, .ofs_x = 12, .ofs_y = 9},
    {.bitmap_index = 6506, .adv_w = 960, .box_w = 23, .box_h = 41, .ofs_x = 17, .ofs_y = 9},
    {.bitmap_index = 6978, .adv_w = 960, .box_w = 46, .box_h = 46, .ofs_x = 7, .ofs_y = 7},
    {.bitmap_index = 8036, .adv_w = 960, .box_w = 46, .box_h = 45, .ofs_x = 7, .ofs_y = 7},
    {.bitmap_index = 9071, .adv_w = 960, .box_w = 26, .box_h = 50, .ofs_x = 17, .ofs_y = 5},
    {.bitmap_index = 9721, .adv_w = 960, .box_w = 33, .box_h = 50, .ofs_x = 12, .ofs_y = 5},
    {.bitmap_index = 10546, .adv_w = 960, .box_w = 56, .box_h = 46, .ofs_x = 2, .ofs_y = 7},
    {.bitmap_index = 11834, .adv_w = 960, .box_w = 36, .box_h = 50, .ofs_x = 12, .ofs_y = 5},
    {.bitmap_index = 12734, .adv_w = 960, .box_w = 56, .box_h = 46, .ofs_x = 2, .ofs_y = 7},
    {.bitmap_index = 14022, .adv_w = 960, .box_w = 30, .box_h = 46, .ofs_x = 15, .ofs_y = 7},
    {.bitmap_index = 14712, .adv_w = 960, .box_w = 42, .box_h = 41, .ofs_x = 9, .ofs_y = 10},
    {.bitmap_index = 15573, .adv_w = 960, .box_w = 45, .box_h = 35, .ofs_x = 8, .ofs_y = 12},
    {.bitmap_index = 16361, .adv_w = 960, .box_w = 19, .box_h = 30, .ofs_x = 20, .ofs_y = 15},
    {.bitmap_index = 16646, .adv_w = 960, .box_w = 19, .box_h = 30, .ofs_x = 21, .ofs_y = 15},
    {.bitmap_index = 16931, .adv_w = 960, .box_w = 36, .box_h = 36, .ofs_x = 12, .ofs_y = 12},
    {.bitmap_index = 17579, .adv_w = 960, .box_w = 41, .box_h = 42, .ofs_x = 10, .ofs_y = 9},
    {.bitmap_index = 18440, .adv_w = 960, .box_w = 56, .box_h = 39, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 19532, .adv_w = 960, .box_w = 56, .box_h = 47, .ofs_x = 2, .ofs_y = 9},
    {.bitmap_index = 20848, .adv_w = 960, .box_w = 50, .box_h = 44, .ofs_x = 5, .ofs_y = 9},
    {.bitmap_index = 21948, .adv_w = 960, .box_w = 50, .box_h = 50, .ofs_x = 5, .ofs_y = 5},
    {.bitmap_index = 23198, .adv_w = 960, .box_w = 45, .box_h = 45, .ofs_x = 7, .ofs_y = 8},
    {.bitmap_index = 24211, .adv_w = 960, .box_w = 50, .box_h = 50, .ofs_x = 5, .ofs_y = 5},
    {.bitmap_index = 25461, .adv_w = 960, .box_w = 36, .box_h = 44, .ofs_x = 12, .ofs_y = 9}
};
