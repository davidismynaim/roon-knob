...
static void test_owned_bounded_values(void) {
    ...
    controller_media_enrichment_view_init(
        &enrichment, next_track_title, NULL, INT32_MIN, "24-bit / 192kHz");
    ...
    controller_media_enrichment_view_init(NULL, NULL, NULL, 0, NULL);
...
static void test_media_enrichment_mapping(void) {
    ...
    controller_media_enrichment_view_t enrichment;
    controller_media_enrichment_view_init(
        &enrichment, "next title", "next artist", 1974, "16-bit / 44.1kHz");
    ...
    controller_media_enrichment_view_init(&enrichment, "", "", 0, "");
    controller_view_compat_apply_media_enrichment(&enrichment);
